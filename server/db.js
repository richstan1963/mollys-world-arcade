...
function seedOriginalGames(database) {
    ...
    const games = [
        ...
        ['flappymae',   'Flappy Pop',       'Pop clouds and flap through pipes! One-touch cloud pop gameplay.',             '🐦', '#C4B5FD'],
        ...
        ['spaceinvaders','Space Invaders',  'Defend Earth from descending alien waves! Shields, UFOs, and escalating chaos.', '👾', '#A855F7'],
        ['contra',       'Contra',          'Run-and-gun through enemy territory! 8-way shooting, color-chain combos, and a brutal boss fight.', '🔫', '#EF4444'],
        ['frogger',      'Frogger',         'Cross busy roads and treacherous rivers! Dodge traffic, ride logs, and fill all five home slots.', '🐸', '#22C55E'],
        ['snake',        'Snake',           'Eat, grow, survive! Classic snake with golden food bonuses and wrap-around mode at level 5.', '🐍', '#22C55E'],
        ['galaga',       'Galaga',          'Blast alien formations! Tractor beam capture, dual fighter mode, and challenge bonus stages.', '👾', '#3B82F6'],
        ['donkeykong',   'Donkey Kong',     'Climb the construction site! Dodge barrels, grab hammers, rescue Pauline from the big ape.', '🦍', '#F59E0B'],
        ['defender',     'Defender',        'Defend the humanoids! Blast aliens, catch falling people, and smart-bomb your way to victory.', '🚀', '#06B6D4'],
        ['digdug',       'Dig Dug',         'Dig underground and pump up enemies until they pop! Drop rocks for bonus crushes.', '⛏️', '#F59E0B'],
        ['qix',          'Qix',             'Claim territory by drawing lines! Avoid the Qix and Sparx. Fill 75% to advance.', '🎯', '#A855F7'],
        ['joust',        'Joust',           'Flap your mount and joust! Higher lance wins. Collect eggs before they hatch into stronger foes.', '🏇', '#EC4899'],
        ['bomberman',    'Bomberman',       'Place bombs, blast walls, find power-ups! Chain explosions and reach the exit to clear each maze.', '💣', '#F59E0B'],
        ['bubbleblaster','Bubble Blaster',  'Trap enemies in colored bubbles, then pop matching colors for chain explosions! A mashup classic.', '🫧', '#3B82F6'],
        ['gravitydash',  'Gravity Dash',    'One-button gravity flipper! Flip between floor and ceiling in this neon synthwave endless runner.', '🌀', '#06B6D4'],
        ['mspacman',     'Ms. Pac-Man',     'Four unique mazes, moving fruit, and smarter ghosts! The sequel that surpassed the original.', '👩', '#F59E0B'],
        ['centipedestrike','Centipede Strike','Centipede meets Missile Command! Click to launch expanding explosions at descending centipedes. Limited ammo, big strategy.', '💥', '#22C55E'],
        ['minniepac',    'Minnie Pac',      'Pink maze, polka-dot bow, heart-shaped power pellets! Pac-Man with Minnie Mouse charm.', '🎀', '#EC4899'],
        ['mickeypop',    'Mickey Pop',      'Bubble-shooting side-scroller! Pop balloon enemies, collect coin patterns, fight the teddy bear boss.', '🐭', '#EF4444'],
        ['princessrun',  'Princess Run',    'Auto-running princess adventure! Rescue animals, collect gems, defeat the dark witch across 4 magical worlds.', '👸', '#EC4899'],
        ['sparklematch', 'Sparkle Match',   'Match-3 jewel puzzle! Create star, rainbow, and bomb gems. Cascading combos and a magic meter.', '💎', '#A855F7'],
        ['jumpdash',     'Jump Dash',       'Endless runner with style! Jump, double-jump, and slide through 5 colorful worlds.', '🏃', '#F59E0B'],
        ['goofypogo',    "Goofy's Pogo",    'Bounce through obstacles on a pogo stick! Charge springs, do flips, collect hot dogs. Floppy ears included.', '🦘', '#22C55E'],
        ['slingshot',    'Slingshot',       'Pull back, aim, destroy! Physics-based destruction with wood, stone, glass, and TNT. 10 levels.', '🏹', '#EF4444'],
        ['skyjump',      'Sky Jump',        'Bounce your way to space! Auto-jumping vertical climber with jetpacks, spring shoes, and UFOs.', '☁️', '#3B82F6'],
        ['cannonblast',  'Cannon Blast',    'Carnival shooting gallery! Arc your cannonballs at ducks, balloons, and targets. They shoot back!', '💥', '#F59E0B'],
        ['toycrush',     'Toy Crush',       'Tap matching toy blocks to crush them! Physics falling, rockets, bombs, disco balls. 20 levels.', '🧸', '#EC4899'],
        ['blockshooter', 'Block Shooter',   'Aim and fire colored blocks at structures! Match 3 to pop, watch loose pieces tumble with physics.', '🎯', '#3B82F6'],
        ['coasterride',  'Coaster Ride',    'Ride the roller coaster! Jump gaps, duck bars, survive loops and drops across 4 themed coasters.', '🎢', '#EF4444'],
        ['railblaster',  'Rail Blaster',    'On-rails shooter! Enemies grow as they approach. Duck behind cover, aim for headshots, fight bosses.', '🔫', '#22C55E'],
        ['pickleball',   'Pickleball',      'The first-ever pickleball arcade game! Drive, lob, dink, and smash with wiffle ball physics.', '🏓', '#22C55E'],
        ['triviatac',    'Trivia Tac',      'Tic Tac Toe powered by trivia! Answer right to claim your spot. Answer wrong and your opponent steals it.', '🧠', '#A855F7'],
        ['savekenny',    'Save Kenny',      'Kenny meditates on a drone! Fly flappy-style while shooting down threats. Cats, UFOs, lightning — OH MY GOD THEY KILLED KENNY!', '🟠', '#F59E0B'],
        ['pool',         '8-Ball Pool',    'Rack em up! Elastic collision physics, aim lines, solids vs stripes. Full 8-ball rules vs AI.', '🎱', '#22C55E'],
        ...
        ['connect4',     'Connect 4',      'Drop discs, get 4 in a row! Minimax AI with 3 difficulty levels. Best of 5 series.', '🔴', '#EF4444'],
        ['fishing',      'Fishing',        'Cast your line and reel em in! 12 fish types, 3 depth zones, timing-based catches. Find the treasure chest!', '🐟', '#3B82F6'],
        ['pixelracer',   'Pixel Racer',    'Top-down lane racer! Dodge traffic, collect coins, nitro boost through 4 environments.', '🏎️', '#EF4444'],
        ['towerdefense', 'Tower Defense',  'Place arrow, cannon, ice, and lightning towers to stop 20 waves of enemies! Upgrade and strategize.', '🏰', '#A855F7'],
        ['rhythmtap',    'Rhythm Tap',     'Hit the notes to the beat! Procedural music, combo multipliers, S-rank accuracy. D/F/J/K to play.', '🎵', '#EC4899'],
    ...
    const del = database.prepare('DELETE FROM original_games WHERE id = ?');
